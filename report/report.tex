...
\gur{Estimate ATE, ATT and derive ATC through the mathematical reltaion}

\gur{For Covariate adjustment, calculate ATE as usual, calculate ATT by only iterating over the treated group and ATC by only terating over the control}
...
\gur{For the doubly robust, use the paper I put in the references and cite it for all the three.}
